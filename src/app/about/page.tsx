...
const team = [
  {
    ...
    bio: "With over 15 years in real estate, Victor leads our company with vision and expertise.",
...
export default function AboutPage() {
  // const [activeTab, setActiveTab] = useState(0) // not used
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-8">
              ...
              <br />
              <span className="text-gray-900">Realty</span>
            </h1>
                ...
                <CardContent className="p-0">
                  <div className="grid md:grid-cols-3 gap-0">
                    ...
                    <div className="bg-gradient-to-br from-amber-500 to-blue-600 p-8 text-white text-center relative overflow-hidden">
                      ...
                      <div className="relative">
                        <h3 className="text-2xl font-bold mb-2">Victor Godwin</h3>
                    ...
                    <div className="md:col-span-2 p-8">
                      ...
                      <div className="mt-8 pt-6 border-t border-gray-200">
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            <p className="font-bold text-gray-900">Victor Godwin</p>
      ...
      {/* Our Customers Section (intentionally removed) */}
